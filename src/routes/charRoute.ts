...
// charRoute.get('/characters/:id', charController.listChar);  // Rota para listar todos os personagens
...
// charRoute.delete('/character', charController.deleteChar); // Rota para deletar um personagem